...
ComputeSNNasym_sparse <- function(SNN, prune, mode) {
    .Call('_CAbiNet_ComputeSNNasym_sparse', PACKAGE = 'CAbiNet', SNN, prune, mode)
}

ComputeSNNasym_dense <- function(SNN, prune, mode) {
    .Call('_CAbiNet_ComputeSNNasym_dense', PACKAGE = 'CAbiNet', SNN, prune, mode)
}
